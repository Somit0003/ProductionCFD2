...
namespace ProductionCFD2.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Material_Id,Material_Number")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Material_Id,Material_Number")] Material material)
        {
