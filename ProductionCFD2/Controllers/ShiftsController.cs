...
namespace ProductionCFD2.Controllers
{
    public class ShiftsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Shift_Id,Shift_Name")] Shift shift)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Shift_Id,Shift_Name")] Shift shift)
        {
